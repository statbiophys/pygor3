...
class MyTestCase(unittest.TestCase):
    ...
    def test_IgorModel_Parms(self):
        ...
        fln_dict = get_default_ref_genomes_species_chain(species, chain)
        ...
        mdl_parms.attach_V_anchors(fln_dict["fln_V_gene_CDR3_anchors"])
        mdl_parms.attach_J_anchors(fln_dict["fln_J_gene_CDR3_anchors"])
